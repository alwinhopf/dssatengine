...
def _build_result_rows(ID: str, summary: pd.DataFrame,
    ...
    return pd.DataFrame({
        ...
        "anthesis_date":                          summary.get("ADAT"),
        "maturity_date":                          summary.get("MDAT"),
        ...
        "pod_weight_kg_ha":                       summary.get("PWAM"),
        "seed_weight_kg":                         summary.get("HWUM"),
        "harvest_index":                          summary.get("HIAM"),
        "maximum_lai":                            summary.get("LAIX"),
