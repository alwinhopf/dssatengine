...
> **Last verified:** 2026-06-18 (by inspection of `requirements.txt`, `environment.yml`, `renv.lock`, `config.R`,
...
| `dssatengine` | R + Python package | `0.3.0` (`pyproject.toml` + `DESCRIPTION`) |
